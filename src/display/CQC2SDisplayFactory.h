...
public:
    ...
    static UniquePtr<CQC2SDisplay> CreateVideoDisplay(String p_videoPath, EVideoFormat p_format = EVideoFormat::Rgb, uint32_t p_fps = 30, String p_name = "video", UniquePtr<CEndCondition> p_pEndCondition = nullptr, String p_nextDisplay = "");
...
#ifdef USE_GLSL
    static UniquePtr<CQC2SDisplay> CreateGLSLDisplay(String p_shaderPath, uint32_t p_fps = 30, uint32_t p_resolutionScale = 1, String p_name = "glsl", UniquePtr<CEndCondition> p_pEndCondition = nullptr, String p_nextDisplay = "", bool p_failSilent = false);
#endif
